...
class DynamicLine {
    ...
    drawPoints() {
        ...
        this.bezierCurveTo(this.point1.x, this.point1.y, cp1x1, cp1y1, cp2x1, cp2y1, this.point2.x, this.point2.y);
        ...
        this.bezierCurveTo(this.point2.x, this.point2.y, cp1x2, cp1y2, cp2x2, cp2y2, this.point3.x, this.point3.y);
        ...
        this.bezierCurveTo(this.point3.x, this.point3.y, cp1x3, cp1y3, cp2x3, cp2y3, this.point4.x, this.point4.y);
        ...
        this.bezierCurveTo(this.point4.x, this.point4.y, cp1x4, cp1y4, cp2x4, cp2y4, this.point5.x, this.point5.y);
        ...
        // END
        this.graphics.lineTo(this.point6.x, this.point6.y);
