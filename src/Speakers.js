                    ...
                    <div className="container-header speakers-header">
                        ...
                        <div className="container-header-flexbox">
                            <div className="container-header-info">
                                <p>This year YGLF is hosting amazing speakers from all around the world. Listed below are our selected speakers. For the whole lineup you can visit our Speakers page. Make sure to check back reguraly as this is just the beginning and we have many more to be announced soon!</p>
                                <BuyTicketsButton/>
                            </div>
                        </div>
                    </div>
